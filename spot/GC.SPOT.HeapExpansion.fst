...
let spot_chunked_nonblue_scanned_raw_targets_in_major_intro
  (mh: MH.major_heap)
  : Lemma
      (requires
        forall (obj: obj_addr) (i: U64.t{U64.v i >= 1}).
...
let spot_chunked_mark_bounded_target_membership_policy_from_nonblue_static
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  : Lemma
      ...
      (ensures
        ChunkedMarkBoundedReadiness.chunked_mark_bounded_target_membership_policy
          mh cap fuel)
  =
  ChunkedMarkBoundedTargetMembership.chunked_mark_bounded_target_membership_policy_from_nonblue_static
    mh cap fuel

let spot_chunked_mark_bounded_preservation_ready_from_nonblue_static
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  : Lemma
      ...
      (ensures
        ChunkedMarkBoundedPres.chunked_mark_bounded_preservation_ready
          mh cap fuel)
  =
  ChunkedMarkBoundedTargetMembership.chunked_mark_bounded_preservation_ready_from_nonblue_static
    mh cap fuel
...
let spot_chunked_major_raw_field_targets_in_major_preserved_by_update
  (minor: minor_state)
  (mh: MH.major_heap)
  (fwd: forwarding_map)
  : Lemma
...
let spot_chunked_nonblue_scanned_raw_targets_in_major_preserved_by_gray_roots
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  : Lemma
      (requires
      ...
      (ensures
        ChunkedMarkBoundedTargetMembership.chunked_nonblue_scanned_raw_targets_in_major
          (ChunkedMajorGCRoots.chunked_gray_roots mh roots))
  =
  ChunkedMarkBoundedTargetMembership.chunked_nonblue_scanned_raw_targets_in_major_preserved_by_gray_roots
    mh roots
...
let spot_chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy_intro
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
  : Lemma
      (requires
        ...
        mark_fuel >= Seq.length (MH.major_objects mh))
      (ensures
        GenMajorGCBridge.chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy
          mh roots cap mark_fuel)
  =
  GenMajorGCBridge.chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy_intro
    mh roots cap mark_fuel

let spot_chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy_from_pre_gray
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
...
let spot_chunked_major_gc_bounded_after_gray_roots_target_membership_policy_from_nonblue_static_raw_targets
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
...
let spot_chunked_major_gc_bounded_after_gray_roots_policy_from_nonblue_static_raw_targets
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
  : Lemma
      ...
      (ensures
        GenMajorGCBridge.chunked_major_gc_bounded_after_gray_roots_policy
          mh roots cap mark_fuel)
  =
  GenMajorGCBridge.chunked_major_gc_bounded_after_gray_roots_policy_from_nonblue_static_raw_targets
    mh roots cap mark_fuel
...
let spot_init_fresh_chunk_header_fields
  ...
  : Lemma
      (ensures
        (let r = SpecMajorAlloc.init_fresh_chunk fresh next_fp in
         ...
         Obj.getWosize hdr == SpecMajorAlloc.fresh_chunk_wosize_u64 fresh /\
         Obj.getColor hdr == Header.Blue /\
         U64.v (Obj.getTag hdr) == 0))
  = SpecMajorAlloc.init_fresh_chunk_header_fields fresh next_fp

let spot_init_fresh_chunk_link
  (fresh: MH.heap_chunk) (next_fp: U64.t)
  : Lemma
      (ensures
        (let r = SpecMajorAlloc.init_fresh_chunk fresh next_fp in
  ...
  = SpecMajorAlloc.init_fresh_chunk_link fresh next_fp

let spot_init_fresh_chunk_single_object
  (fresh: MH.heap_chunk) (next_fp: U64.t)
  : Lemma
      (ensures
        (let r = SpecMajorAlloc.init_fresh_chunk fresh next_fp in
         MH.objects_in_chunk r.chunk_out == Seq.cons r.fp_out Seq.empty))
  = SpecMajorAlloc.init_fresh_chunk_objects fresh next_fp
...
let spot_major_alloc_head_split_nonblue_origin
  (mh: MH.major_heap) (fp: U64.t)
  (requested_wz fuel: nat)
  : Lemma
      (requires fuel > 1 /\
...
let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_gray_nonblue_static_raw_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_gray_nonblue_static_raw_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_nonblue_static_raw_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  ...
  : Lemma
      (requires
        ...
        (let r =
         ...
         GenMajorGCBridge.chunked_major_field_targets_non_infix
           collect.cmc_major /\
         ChunkedCheneyInjectivity.chunked_nonblue_scanned_raw_targets_in_major
           prom.major_final /\
         GenInv.chunked_major_minor_fields_no_infix_targets
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_nonblue_static_raw_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_nonblue_static_raw_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_nonblue_static_raw_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_nonblue_static_raw_target_policy_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_nonblue_static_raw_target_policy_from_budget_ready
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_raw_field_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_raw_field_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_raw_field_target_policy_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_promote_raw_field_target_policy_from_budget_ready
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_preflight_chunk_base_pre_promote_raw_field_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_preflight_chunk_base_pre_promote_raw_field_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_preflight_chunk_base_pre_promote_raw_field_target_policy_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_preflight_chunk_base_pre_promote_raw_field_target_policy_from_budget_ready
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel
...
let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_raw_field_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_raw_field_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_raw_field_and_non_infix_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_raw_field_and_non_infix_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_chunk_base_raw_field_and_non_infix_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_pre_update_chunk_base_raw_field_and_non_infix_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_preflight_chunk_base_pre_update_raw_field_and_non_infix_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_preflight_chunk_base_pre_update_raw_field_and_non_infix_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel

let spot_chunked_cheney_collect_then_major_gc_live_subgraph_from_chunk_base_raw_field_target_policy
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (major_roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
        ...
        (let r =
         ...
         ChunkedMajorGCGraph.chunked_major_live_subgraph_preserved
           ...
           (ChunkedMajorGCCorr.chunked_major_initial_reachable_live
             collect.cmc_major major_roots)))
  =
  CheneyGraphReadiness.chunked_cheney_collect_then_major_gc_live_subgraph_from_chunk_base_raw_field_target_policy
    minor major fp roots alloc_fuel fresh major_roots cap mark_fuel
...
let spot_chunked_update_major_pointers_preserves_ranges
  (major: MH.major_heap) (fwd: forwarding_map)
  : Lemma
      (ensures
        ChunkedSweepRange.same_chunk_ranges major
          (ChunkedUpdate.chunked_update_major_pointers major fwd))
  =
  ChunkedUpdate.chunked_update_major_pointers_preserves_ranges major fwd

let spot_chunked_update_field_slot_from_major_field_slot
  (src: obj_addr) (i: nat) (field_addr: hp_addr)
  : Lemma
      (requires CG.chunked_major_field_slot src i == Some field_addr)
      (ensures ChunkedUpdate.chunked_update_field_slot src i == Some field_addr)
  =
...
let spot_chunked_cheney_promote_fwd_noninfix_sources_valid
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat)
  : Lemma
      (ensures
        (let res =
          ChunkedCheney.chunked_cheney_promote
            minor major fp roots alloc_fuel in
         ChunkedCheneyInjectivity.chunked_fwd_noninfix_sources_valid
          minor res.fwd_map))
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_fwd_noninfix_sources_valid
    minor major fp roots alloc_fuel

let spot_chunked_cheney_promote_fwd_noninfix_targets_not_infix
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (remaining: nat)
  : Lemma
      (requires
      ...
      (ensures
        (let res =
         ...
         GenMajorGCBridge.chunked_fwd_noninfix_targets_not_infix
           minor res.fwd_map res.major_final))
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_fwd_noninfix_targets_not_infix
    minor major fp roots alloc_fuel remaining

let spot_chunked_cheney_promote_updated_fwd_noninfix_targets_not_infix
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (remaining: nat)
  : Lemma
      (requires
  ...
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_updated_fwd_noninfix_targets_not_infix
    minor major fp roots alloc_fuel remaining

let spot_chunked_nonblue_scanned_raw_targets_in_major_to_bounded
  (mh: MH.major_heap)
  : Lemma
      (requires
        MH.well_formed_major_heap mh /\
      ...
      (ensures
        ChunkedMarkBoundedTargetMembership.chunked_nonblue_scanned_raw_targets_in_major
          mh)
  =
  ChunkedCheneyInjectivity.chunked_nonblue_scanned_raw_targets_in_major_to_bounded
    mh

let spot_chunked_cheney_promote_fwd_target_minor_field_no_infix
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (remaining: nat)
  ...
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_fwd_target_minor_field_no_infix
    minor major fp roots alloc_fuel remaining x j field_addr raw

let spot_chunked_cheney_promote_old_nonblue_field_no_infix
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat)
  (src: obj_addr) (hdr: U64.t) (j: nat) (field_addr: hp_addr)
  (old: U64.t) (raw: U64.t)
...
let spot_chunked_cheney_promote_old_nonblue_field_no_infix_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (remaining: nat)
  (src: obj_addr) (hdr: U64.t) (j: nat) (field_addr: hp_addr)
  (old: U64.t) (raw: U64.t)
  : Lemma
      ...
      (ensures ~(is_infix_in_minor minor (to_minor_offset raw)))
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_old_nonblue_field_no_infix_from_budget_ready
    minor major fp roots alloc_fuel remaining src hdr j field_addr old raw
...
let spot_chunked_cheney_forward_normal_success_preserves_nonblue_origin_inv
  (minor: minor_state) (major0: MH.major_heap)
  (cs: ChunkedCheney.chunked_cheney_state) (addr: U64.t) (fuel: nat)
  : Lemma
      (requires
  ...
  : Lemma
      (requires
        ...
        (let res =
         ...
         ChunkedMarkDefs.chunked_is_pointer_field res.major_final raw))
      (ensures
        (let res =
          ChunkedCheney.chunked_cheney_promote
            minor major fp roots alloc_fuel in
         Seq.mem (ChunkedMarkDefs.chunked_pointer_field_as_obj_addr
                    res.major_final raw)
           (MH.major_objects res.major_final)))
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_fwd_target_minor_major_field_raw_target
    minor major fp roots alloc_fuel remaining x j field_addr raw

let spot_chunked_cheney_promote_fwd_target_minor_major_field_raw_target_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (remaining: nat)
  (x: U64.t) (j: nat) (field_addr: hp_addr) (raw: U64.t)
  : Lemma
      ...
      (ensures
        (let res =
         ...
         Seq.mem (ChunkedMarkDefs.chunked_pointer_field_as_obj_addr
          ...
          (MH.major_objects res.major_final)))
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_fwd_target_minor_major_field_raw_target_from_budget_ready
    minor major fp roots alloc_fuel remaining x j field_addr raw

let spot_chunked_cheney_promote_old_nonblue_field_raw_target
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat)
  (src: obj_addr) (hdr: U64.t) (j: nat) (field_addr: hp_addr)
  (old: U64.t) (raw: U64.t)
  : Lemma
      (requires
        ...
        U64.v field_addr == U64.v src + j * U64.v mword /\
        MH.read_word_in_major major field_addr == Some old /\
        ChunkedMarkDefs.chunked_is_pointer_field major old /\
        (let res =
          ChunkedCheney.chunked_cheney_promote
            minor major fp roots alloc_fuel in
         MH.read_word_in_major res.major_final field_addr == Some raw /\
...
let spot_chunked_cheney_promote_old_nonblue_field_raw_target_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel: nat) (remaining: nat)
  (src: obj_addr) (hdr: U64.t) (j: nat) (field_addr: hp_addr)
  (old: U64.t) (raw: U64.t)
      ...
      (ensures
        (let res =
         ...
         Seq.mem (ChunkedMarkDefs.chunked_pointer_field_as_obj_addr
           ...
           (MH.major_objects res.major_final)))
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_old_nonblue_field_raw_target_from_budget_ready
    minor major fp roots alloc_fuel remaining src hdr j field_addr old raw
...
let spot_chunked_cheney_promote_field_source_cases_from_nonblue_origin_from_budget_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: Seq.seq U64.t) (alloc_fuel remaining: nat)
  : Lemma
      (requires
      ...
      (ensures
        ChunkedCheneyInjectivity.chunked_cheney_promote_field_source_cases
          minor major fp roots alloc_fuel)
  =
  ChunkedCheneyInjectivity.chunked_cheney_promote_field_source_cases_from_nonblue_origin_from_budget_ready
    minor major fp roots alloc_fuel remaining
...
let spot_chunked_nonblue_scanned_raw_targets_in_major_from_major_raw_field_targets
  (mh: MH.major_heap)
  : Lemma
      (requires
        MH.well_formed_major_heap mh /\
  ...
  =
  ChunkedCheneyInjectivity
    .chunked_nonblue_scanned_raw_targets_in_major_from_major_raw_field_targets
    mh
