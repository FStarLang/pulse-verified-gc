...
/// ---------------------------------------------------------------------------
/// NOTE: gen_gc_iso was removed — it had circular preconditions that required
/// the caller to prove the isomorphism as a precondition.
/// The real isomorphism theorem is in GC.Gen.MinorCollectIso.
/// ---------------------------------------------------------------------------
