...
/// ---------------------------------------------------------------------------
/// gen_gc_iso: gen_gc + isomorphism postcondition
/// ---------------------------------------------------------------------------
      ...
      TopLevel.isomorphism_postcondition minor_st 's 'fp 'rs combined_roots 'st res.mc_fp)
{
  ...
  // Phase 5: Ghost — derive isomorphism postcondition
  TopLevel.gen_gc_isomorphism_opaque
    ({ data = 'd; bump = 'b } <: minor_state) 's 'fp 'rs combined_roots 'st
