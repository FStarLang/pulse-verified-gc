...
let chunked_collection_heap_shape_ensure_head_capacity_with_chain_blue
  (minor: minor_state) (mh: MH.major_heap)
  (fp: U64.t) (fuel: nat) (needed: nat{needed > 0})
  (fresh: MH.heap_chunk)
  : Lemma
      ...
      (ensures (
        ...
        chunked_chain_objects_blue
          r.capacity_major_out r.capacity_fp_out r.capacity_fuel_out))
  =
  chunked_collection_heap_shape_ensure_head_capacity_with_chain
    minor mh fp fuel needed fresh;
  chunked_collection_heap_shape_elim minor mh fp fuel;
  chunked_major_alloc_shape_elim mh fp fuel;
  chunked_chain_objects_blue_ensure_head_capacity
    mh fp fuel needed fresh

#push-options "--split_queries always --z3rlimit 10 --fuel 0 --ifuel 0"
let chunked_collection_heap_shape_ensure_head_capacity_with_chain_blue_value_safety
  (minor: minor_state) (mh: MH.major_heap)
  (fp: U64.t) (fuel: nat) (needed: nat{needed > 0})
  (fresh: MH.heap_chunk)
  : Lemma
  ...
  chunked_collection_heap_shape_ensure_head_capacity_with_chain_blue
    minor mh fp fuel needed fresh
#pop-options
...
let chunked_collection_heap_shape_ensure_minor_promotion_budget_alloc_list_value_safety
  (minor: minor_state) (mh: MH.major_heap)
  (fp: U64.t) (fuel: nat) (fresh: MH.heap_chunk)
  (requests: list nat)
  : Lemma
      ...
      (ensures (
        ...
        SpecMajorAllocMultiAlloc.allocated_objects_nonzero
          a.list_objs_out))
  =
  chunked_collection_heap_shape_ensure_head_capacity_alloc_list_with_budget_value_safety
    minor mh fp fuel fresh requests
    (PromotionDemand.minor_promotion_demand minor)
...
let chunked_collection_heap_shape_ensure_minor_promotion_head_capacity_allocs_value_safety
  (minor: minor_state) (mh: MH.major_heap)
  (fp: U64.t) (fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
      (requires fuel > 1 /\
  ...
  PromotionDemand.minor_promotion_requests_positive minor;
  PromotionDemand.minor_promotion_demand_eq minor;
  chunked_collection_heap_shape_ensure_minor_promotion_budget_alloc_list_value_safety
    minor mh fp fuel fresh (PromotionDemand.minor_promotion_requests minor)
