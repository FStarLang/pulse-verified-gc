...
val chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
...
val chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy_intro
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
...
val chunked_major_gc_bounded_after_gray_roots_nonblue_static_raw_target_policy_from_pre_gray
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
...
val chunked_major_gc_bounded_after_gray_roots_target_membership_policy_from_nonblue_static_raw_targets
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
...
val chunked_major_gc_bounded_after_gray_roots_policy_from_nonblue_static_raw_targets
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (mark_fuel: nat)
