...
module FP = GC.Gen.PromoteUpdate.PromoteFields.FieldsPres
module FR = GC.Gen.PromoteUpdate.PromoteFields.Frame
...
let promote_all_preserves_fields
  ...
  = FP.promote_all_preserves_fields minor major fp live_set
...
let promote_all_read_other
  ...
  = FR.promote_all_read_other minor major fp live_set other addr
