...
/// Proof: BFS induction using promote_object_frame_old_field at each step.
/// Non-blue objects avoid the free-list chain (chain_objects_blue), so
/// alloc_spec never overwrites their body.
#push-options "--z3rlimit 50 --fuel 0 --ifuel 0"
