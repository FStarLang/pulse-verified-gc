...
/// Same promoted-minor successor edge consequence, but hides the copied
/// payload address behind an explicit field-slot existence witness.
val chunked_cheney_gc_correct_after_preflight_minor_successor_major_edge_no_field_addr
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (src dst: U64.t) (j: nat)
  : Lemma
...
/// Pointwise graph-edge mapping consequence for reachable minor successor
/// fields.  This packages the pre-collection MinorV->MinorV edge together with
/// the post-collection MajorV->MajorV edge between the forwarding targets.
val chunked_cheney_gc_correct_after_preflight_minor_successor_edge_maps_to_major_edge
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (src dst: U64.t) (j: nat) (field_addr: hp_addr)
  : Lemma
...
/// Pointwise graph-edge mapping without an explicit promoted payload address.
val chunked_cheney_gc_correct_after_preflight_minor_successor_edge_maps_to_major_edge_no_field_addr
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (src dst: U64.t) (j: nat)
  : Lemma
...
/// Graph-edge-level form of the promoted-minor successor mapping.  Instead of
/// exposing the source field index, this consumes an actual pre-collection
/// MinorV->MinorV graph edge and recovers the copied field witness internally.
val chunked_cheney_gc_correct_after_preflight_minor_graph_edge_maps_to_major_edge
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (src dst: U64.t)
  : Lemma
...
/// Graph-edge-level form for reachable promoted-minor edges whose pre-state
/// target was already an old major object.  The side condition matches the
/// major-pointer update guard: if the raw major address also aliases a
/// forwarded minor pointer value, the copied field is rewritten and the target
/// is not necessarily `dst`.
val chunked_cheney_gc_correct_after_preflight_minor_major_graph_edge_maps_to_major_edge
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
...
val chunked_cheney_gc_correct_after_preflight_value_safety
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
    (requires
...
/// Composed promoted-minor successor edge bridge.  A successful normal
/// head-split forwarding step copies the source field into the promoted object;
/// forwarding that promoted object's fields then forwards the positive
/// minor-object successor, and the final chunked update graph contains the
/// corresponding MajorV->MajorV edge.
val chunked_forward_one_normal_then_fields_minor_successor_edge
  (minor: minor_state) (cs: ChunkedCheney.chunked_cheney_state)
  (addr: U64.t) (fuel: nat) (j: nat)
...
/// Source-vertex side condition for the chunked graph morphism surface.  We map
/// old major vertices by identity and reachable positive-size minor vertices
/// through the forwarding map.  Zero-sized minor objects are excluded because
/// collection is allowed to leave their forwarding entry at zero.
let chunked_graph_vertex_maps_to_major_ready
...
/// One-vertex image theorem for the chunked preflight collector over the
/// old-major plus reachable-minor subgraph.
val chunked_cheney_gc_correct_after_preflight_graph_vertex_maps_to_major_vertex
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
...
let chunked_graph_vertices_map_to_major_vertices_prop
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
...
val chunked_cheney_gc_correct_after_preflight_graph_vertices_map_to_major_vertices
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
    (requires
...
/// old-major plus reachable-minor subgraph.  Under
/// `chunked_graph_edge_maps_to_major_ready`, any concrete pre-collection
/// combined edge maps to a concrete post-collection major edge by
/// `CG.fwd_morphism collect.cmc_fwd`.
...
let chunked_graph_edges_map_to_major_edges_prop
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk) : prop =
  let needed = PromotionDemand.minor_promotion_demand minor + 1 in
  let r =
...
val chunked_cheney_gc_correct_after_preflight_graph_edges_map_to_major_edges
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
    (requires
...
/// Forward graph-morphism surface for the chunked preflight collector: every
/// ready old/reachable source vertex maps to a post-collection major vertex, and
/// every ready old/reachable source edge maps to a post-collection major edge.
let chunked_graph_maps_to_major_graph_prop
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk) : prop =
  chunked_graph_vertices_map_to_major_vertices_prop
    minor major fp roots alloc_fuel fresh /\
...
val chunked_cheney_gc_correct_after_preflight_graph_maps_to_major_graph
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
    (requires
...
/// Variant of edge readiness that replaces the raw update nonrewrite side
/// condition for major targets with the simpler fact that the target address is
/// outside the minor range. This is the form future chunk-range invariants
/// should discharge for ordinary major-object targets.
let chunked_graph_edge_maps_to_major_above_minor_targets_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (u v: CG.combined_vertex) : GTot prop =
  let needed = PromotionDemand.minor_promotion_demand minor + 1 in
...
val chunked_graph_edge_maps_to_major_above_minor_targets_ready_implies_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (u v: CG.combined_vertex)
  : Lemma
...
val chunked_cheney_gc_correct_after_preflight_graph_edge_above_minor_targets_maps_to_major_edge
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (u v: CG.combined_vertex)
  : Lemma
...
let chunked_graph_edges_above_minor_targets_map_to_major_edges_prop
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk) : prop =
  let needed = PromotionDemand.minor_promotion_demand minor + 1 in
  let r =
...
val chunked_cheney_gc_correct_after_preflight_graph_edges_above_minor_targets_map_to_major_edges
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
    (requires
...
/// Edge readiness variant that also replaces major-source header witnesses with
/// active non-blue object membership.  This is closer to the heap-invariant
/// vocabulary: clients can prove `~(chunked_is_blue major src)` and let this
/// bridge recover the concrete header witness required by update framing.
let chunked_graph_edge_maps_to_major_nonblue_sources_above_minor_targets_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (u v: CG.combined_vertex) : GTot prop =
  let needed = PromotionDemand.minor_promotion_demand minor + 1 in
...
val chunked_graph_edge_maps_to_major_nonblue_sources_above_minor_targets_ready_implies_above_minor_targets_ready
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (u v: CG.combined_vertex)
  : Lemma
...
val chunked_cheney_gc_correct_after_preflight_graph_edge_nonblue_sources_above_minor_targets_maps_to_major_edge
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  (u v: CG.combined_vertex)
  : Lemma
...
let chunked_graph_edges_nonblue_sources_above_minor_targets_map_to_major_edges_prop
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk) : prop =
  let needed = PromotionDemand.minor_promotion_demand minor + 1 in
  let r =
...
val chunked_cheney_gc_correct_after_preflight_graph_edges_nonblue_sources_above_minor_targets_map_to_major_edges
  (minor: minor_state) (major: MH.major_heap) (fp: U64.t)
  (roots: seq U64.t) (alloc_fuel: nat) (fresh: MH.heap_chunk)
  : Lemma
    (requires
