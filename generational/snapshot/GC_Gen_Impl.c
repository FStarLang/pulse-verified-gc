/*
  ...
  KaRaMeL invocation: /home/nswamy/workspace/pulse-verified-gc/generational/../fstar/karamel/krml -tmpdir _extract -skip-compilation -skip-linking -bundle GC.Gen.Impl+GC.Gen.Impl.MinorHeap+GC.Gen.Impl.Cheney+GC.Gen.Impl.UpdatePtrs+GC.Impl+GC.Impl.MarkBounded=GC.Gen.Impl.*,GC.Impl.*[rename=GC_Gen_Impl] -bundle FStar.Pervasives.Native -bundle GC.Spec.ZeroAddr=GC.Spec.ZeroAddr -bundle GC.Gen.Base,GC.Spec.*,GC.Lib.Header,GC.Lib.Address -no-prefix GC.Gen.Impl -no-prefix GC.Gen.Impl.MinorHeap -no-prefix GC.Gen.Impl.Cheney -no-prefix GC.Gen.Impl.Promote -no-prefix GC.Gen.Impl.UpdatePtrs -no-prefix GC.Gen.Base -no-prefix GC.Impl -no-prefix GC.Impl.Fields -no-prefix GC.Impl.Closure -no-prefix GC.Impl.Mark -no-prefix GC.Impl.MarkBounded -no-prefix GC.Impl.Sweep -no-prefix GC.Impl.Coalesce -no-prefix GC.Impl.FusedSweepCoalesce -no-prefix GC.Impl.MajorHeap -no-prefix GC.Impl.ArrayWord -no-prefix GC.Impl.Heap -no-prefix GC.Impl.Object -no-prefix GC.Impl.Stack -no-prefix GC.Spec.ZeroAddr -no-prefix GC.Spec.Base -no-prefix GC.Spec.Heap -no-prefix GC.Spec.Object -no-prefix GC.Lib.Header -no-prefix GC.Lib.Address -fnoshort-names -warn-error -2-9-15 _output/GC_Gen_Impl.krml _output/GC_Gen_Impl_MinorHeap.krml _output/GC_Gen_Impl_Cheney.krml _output/GC_Gen_Impl_Promote.krml _output/GC_Gen_Impl_UpdatePtrs.krml _output/GC_Gen_Base.krml _output/GC_Impl.krml _output/GC_Impl_Fields.krml _output/GC_Impl_Closure.krml _output/GC_Impl_Mark.krml _output/GC_Impl_MarkBounded.krml _output/GC_Impl_Sweep.krml _output/GC_Impl_Coalesce.krml _output/GC_Impl_FusedSweepCoalesce.krml _output/GC_Impl_Allocator.krml _output/GC_Impl_MajorHeap.krml _output/GC_Impl_ArrayWord.krml _output/GC_Impl_Heap.krml _output/GC_Impl_Object.krml _output/GC_Impl_Stack.krml _output/GC_Spec_ZeroAddr.krml _output/GC_Spec_Base.krml _output/GC_Spec_Heap.krml _output/GC_Spec_Object.krml _output/GC_Lib_Header.krml _output/GC_Lib_Address.krml _output/FStar_Pervasives_Native.krml
  F* version: <unknown>
...
static bool GC_Impl_Allocator_is_valid_fp(uint64_t v)
{
  return v >= zero_addr1 + 8ULL && v < heap_size_u640 && v % 8ULL == 0ULL;
}

static uint64_t GC_Impl_Allocator_init_heap(heap_t heap)
{
...
GC_Impl_Allocator_allocate(heap_t heap, uint64_t fp, uint64_t wosize)
{
  ...
  while (go)
  {
    ...
    else
    {
      ...
      bool valid = GC_Impl_Allocator_is_valid_fp(vcur);
      if (!valid)
        go = false;
      else
      {
...
static K___uint64_t_uint64_t
GC_Impl_Allocator_allocate_part1(heap_t heap, uint64_t fp, uint64_t wosize)
{
  uint64_t wz = wosize == 0ULL ? 1ULL : wosize;
  uint64_t head_fp = fp;
  uint64_t prev_fp = 0ULL;
...
static K___uint64_t_uint64_t
GC_Impl_Allocator_allocate_part1_single_indexed_major(
  heap_t heap,
  uint64_t fp,
  uint64_t wosize
)
...
static uint64_t FStar_Pervasives_Native_fst__uint64_t_uint64_t(K___uint64_t_uint64_t x)
{
  return x.fst;
}

static uint64_t FStar_Pervasives_Native_snd__uint64_t_uint64_t(K___uint64_t_uint64_t x)
{
  return x.snd;
}
...
static uint64_t fused_sweep_coalesce(heap_t heap)
{
  ...
  while (cond)
  {
    ...
    if (uu___is_Black(clr))
    {
      ...
      uint64_t new_rw = FStar_Pervasives_Native_fst__uint64_t_uint64_t(res);
      uint64_t new_fv = FStar_Pervasives_Native_snd__uint64_t_uint64_t(res);
  ...
  return FStar_Pervasives_Native_snd__uint64_t_uint64_t(res);
}
...
uint64_t gen_alloc(gen_heap_t gh, uint64_t wosize, uint64_t tag)
{
  if (wosize <= max_young_wosize_u64)
  {
    ...
    if (obj == 0ULL)
    {
      ...
      K___uint64_t_uint64_t res = GC_Impl_Allocator_allocate(gh.major, fp, wosize);
      *gh.fp_ref = FStar_Pervasives_Native_fst__uint64_t_uint64_t(res);
      return FStar_Pervasives_Native_snd__uint64_t_uint64_t(res);
    }
    else
      return obj;
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      res = GC_Impl_Allocator_allocate_part1_single_indexed_major(major, fp, wosize1);
      uint64_t new_fp = FStar_Pervasives_Native_fst__uint64_t_uint64_t(res);
      uint64_t new_obj = FStar_Pervasives_Native_snd__uint64_t_uint64_t(res);
      *fp_ref = new_fp;
      if (new_obj == 0ULL)
        new_parent_addr = 0ULL;
      else
                  ...
                  if (tag == 249ULL)
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        K___uint64_t_uint64_t
                        res =
                          GC_Impl_Allocator_allocate_part1_single_indexed_major(major,
                            fp,
                            wosize2);
                        uint64_t new_fp = FStar_Pervasives_Native_fst__uint64_t_uint64_t(res);
                        uint64_t new_obj = FStar_Pervasives_Native_snd__uint64_t_uint64_t(res);
...
{
  return GC_Impl_Allocator_init_heap(heap);
}

K___uint64_t_uint64_t allocate(heap_t heap, uint64_t fp, uint64_t wosize)
{
  return GC_Impl_Allocator_allocate(heap, fp, wosize);
}
...
static void mark_step_bounded_impl(heap_t heap, gray_stack_rec st)
{
  ...
  uint64_t wz = FStar_Pervasives_Native_fst__uint64_t_uint64_t(r);
  uint64_t tag = FStar_Pervasives_Native_snd__uint64_t_uint64_t(r);
