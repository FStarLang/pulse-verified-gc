...
val alloc_spec_read_other : (g: heap) -> (fp: U64.t) -> (requested_wz: nat) ->
  ...
  Lemma (requires well_formed_heap_part1 g /\
                  ...
                  chain_avoids g fp other alloc_search_fuel = true /\
