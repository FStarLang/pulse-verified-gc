...
val chunked_major_gc_selected_live
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  (live: obj_addr -> prop)
...
val chunked_major_marked_reachable_live
  (mh: MH.major_heap)
...
val chunked_major_initial_reachable_live
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (target: obj_addr)
  : prop

val chunked_major_marked_reachable_live_intro
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (fuel: nat)
...
val chunked_major_marked_reachable_live_elim
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (fuel: nat)
...
val chunked_major_initial_reachable_live_intro
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (target: obj_addr)
  : Lemma
      (requires
        ChunkedMajorReach.chunked_major_reachable_from_roots
          mh roots target)
      (ensures chunked_major_initial_reachable_live mh roots target)

val chunked_major_initial_reachable_live_elim
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (target: obj_addr)
  : Lemma
...
val chunked_major_gc_selected_live_intro
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  (live: obj_addr -> prop)
...
val chunked_major_gc_selected_live_elim
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  (live: obj_addr -> prop)
...
val chunked_major_gc_bounded_live_subgraph_preserved_from_selected_live
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  (live: obj_addr -> prop)
...
val chunked_major_gc_bounded_initial_reachable_live_subgraph_preserved
  (mh: MH.major_heap)
  (roots: Seq.seq obj_addr)
  (cap: nat{cap > 0})
  (fuel: nat)
