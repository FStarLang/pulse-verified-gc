...
val chunked_push_children_bounded_preserves_tag_of_object
  (mh: MH.major_heap)
  (st: Seq.seq obj_addr)
  (obj: obj_addr)
  (i: U64.t{U64.v i >= 1})
...
val chunked_push_children_bounded_preserves_infix_status
  (mh: MH.major_heap)
  (st: Seq.seq obj_addr)
  (obj: obj_addr)
  (i: U64.t{U64.v i >= 1})
...
val chunked_mark_step_bounded_preserves_tag_of_object
  (mh: MH.major_heap)
  (st: Seq.seq obj_addr)
  (cap: nat)
  (target: obj_addr)
...
val chunked_mark_step_bounded_preserves_infix_status
  (mh: MH.major_heap)
  (st: Seq.seq obj_addr)
  (cap: nat)
  (target: obj_addr)
...
val chunked_mark_inner_loop_preserves_tag_of_object
  (mh: MH.major_heap)
  (st: Seq.seq obj_addr)
  (cap: nat)
  (fuel: nat)
...
val chunked_mark_inner_loop_preserves_infix_status
  (mh: MH.major_heap)
  (st: Seq.seq obj_addr)
  (cap: nat)
  (fuel: nat)
...
val chunked_mark_bounded_preserves_tag_of_object
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  (target: obj_addr)
...
val chunked_mark_bounded_preserves_infix_status
  (mh: MH.major_heap)
  (cap: nat{cap > 0})
  (fuel: nat)
  (target: obj_addr)
