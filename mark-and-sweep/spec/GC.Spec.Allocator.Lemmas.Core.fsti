...
/// chain_avoids_transfer_excl2_obj: variant of chain_avoids_transfer_excl2 with the forall
/// quantified over obj_addr (avoids (a <: obj_addr) coercion in VCs that Z3 4.13.3 struggles with).
