...
/// Both check: v % 8 == 0 ∧ v >= zero_addr + mword ∧ v < heap_size
...
let mark_step_scan_preserves_objects
  ...
  : Lemma (requires SpecMarkInv.mark_inv g (Seq.cons f_addr tl) /\
          ...
          (ensures (let g' = SpecObject.makeBlack f_addr g in
                    ...
                    SpecFields.objects zero_addr g'' == SpecFields.objects zero_addr g))
  = SpecMarkInv.mark_inv_elim_wfh g (Seq.cons f_addr tl);
    ...
    SpecMark.color_change_preserves_wf g f_addr GC.Lib.Header.Black;
    SpecObject.makeBlack_eq f_addr g;
    SpecFields.color_change_preserves_objects_mem g f_addr GC.Lib.Header.Black f_addr;
    SpecObject.set_object_color_preserves_getWosize_at_hd f_addr g GC.Lib.Header.Black;
    SpecObject.wosize_of_object_spec f_addr g;
    SpecObject.wosize_of_object_spec f_addr g';
